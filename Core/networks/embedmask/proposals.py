...
from Core.structures.boxlist_ops import cat_boxlist,remove_small_boxes,boxes_to_masks,boxlist_ml_nms
from Core.layers.misc import interpolate
import math

INF = 100000000

class EmbedMaskProposal(nn.Module):
    """
    ...
    def __init__(self,cfg):
        ...
        Arguments:
            ...
            box_coder (BoxCoder)
        """
        super(EmbedMaskProposal, self).__init__()
